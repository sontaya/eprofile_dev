              ...
              <form id="education" name="education" enctype="multipart/form-data" method="post" action="education_data_save.php"  target="upload_target" >
                <table width="748" border="0" cellspacing="4" cellpadding="4">
                  ...
                  <tr>
                    ...
                    <td align="left"><input type="text" name="edu_name" id="edu_name" style="width: 210px; " class="input_text" onblur="get_short_name(this.value)" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="right" class="form_text">&nbsp;* ชื่อย่อของวุฒิ :</td>
                    <td align="left"><input type="text" name="edu_name_short" id="edu_name_short" style="width: 70px; " class="input_text" onfocus="get_short_name($('#edu_name').val())"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="right" class="form_text">&nbsp;* เกรดเฉลี่ย (GPA) :</td>
                    <td align="left"><input type="text" name="edu_gpa" id="edu_gpa" style="width: 50px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?> /></td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="2" align="left"><input type="text" name="edu_from" id="edu_from" style="width: 370px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                  </tr>
                  <tr id="up_row">
