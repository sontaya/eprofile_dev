...
while (($row = oci_fetch_array($stid, OCI_BOTH))) {
	...
	$n++;
echo "\n<tr bgcolor='".$bgcolor."'><td>$n.</td><td width='400' align='left'><samp style='cursor:pointer' title='เลือก' onclick=\"pick_nation7('$n')\">".$row['NATION_NAME_TH']."(".$row['NATION_NAME_ENG'].")</samp> <input type='hidden' id='id$n' value='".$row['NATION_ID']."' ><input type='hidden' id='name$n' value='".$row['NATION_NAME_TH']."' >";
//echo "<br />";
echo " ";
