...
<script type="text/javascript" language="javascript">
  ...
  function show_upload(id,target,file,pic,title,txt){
    $("div#show_upload"+id).html("<input type=\"file\" name=\""+target+"\" id=\""+target+"\" class=\"file_upload\" <?php if ((is_file('files/bio_data_file/'.$row["BIO_PIC_FILE"])==false) || $row["BIO_PIC_FILE"]=='') { ?> onfocus=\"myDisable(this)\"<?php } ?> /> <input type=\"button\" value=\"Cancel\" onclick=\"cancel_upload('"+id+"','"+target+"','"+file+"','"+pic+"','"+title+"','"+txt+"')\"/>"+txt+"");
  }
...
?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly<?php } ?>/></td>
                      ...
                      <tr>
                        <td width="33%" align="left">
                          ...
                          <!--<select name="bio_nation1" id="bio_nation1"  style="width: 130px" >-->
                            ...
                            <input id="auto_bio_nation1" type="text" class="input_text"  value="<?= $name_country ?>" style="width: 130px;"  <?php if ($_SESSION['USER_TYPE'] != 'admin' && $_SESSION['USER_TYPE'] != 'hr') { ?> onfocus="myDisable(this)"<?php } ?><?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?><?php } ?>/>
                        ...
                        <td width="36%" align="left">
                          ...
                          <!--<select name="bio_nation2" class="b_gray" id="bio_nation2" style="width: 130px" <?php if ($_SESSION['USER_TYPE'] != 'admin' && $_SESSION['USER_TYPE'] != 'hr') { ?>onfocus="myDisable(this)"<?php } ?><?php if (($_SESSION['USER_TYPE'] == 'user') || $_SESSION['USER_TYPE'] == 'chief') { ?><?php } ?>>
                            ...
                            <input id="auto_bio_nation2" type="text" class="input_text"   value="<?= $name_country ?>" />  
              ...
              <table width="100%">
                ...
                <tr>
                  <td align="right" class="form_text">ความพิการ :</td>
                  <td align="left">
                    <select name="deformation" class="b_gray" id="deformation"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this)"<?php } ?>>
                      <option value="00" <? if ($row["BIO_DEFORMATION"] == "00") { echo "selected='selected'"; } ?>>00 ไม่พิการ</option>
                      <option value="01" <? if ($row["BIO_DEFORMATION"] == "01") { echo "selected='selected'"; } ?>>01 ความบกพร่องทางการเห็น</option>
                      <option value="02" <? if ($row["BIO_DEFORMATION"] == "02") { echo "selected='selected'"; } ?>>02 ความบกพร่องทางการได้ยิน</option>
                      <option value="03" <? if ($row["BIO_DEFORMATION"] == "03") { echo "selected='selected'"; } ?>>03 ความบกพร่องทางสติปัญญา</option>
                      <option value="04" <? if ($row["BIO_DEFORMATION"] == "04") { echo "selected='selected'"; } ?>>04 ความบกพร่องทางร่างกายหรือสุขภาพ</option>
                      <option value="05" <? if ($row["BIO_DEFORMATION"] == "05") { echo "selected='selected'"; } ?>>05 มีปัญหาทางการเรียนรู้</option>
                      <option value="06" <? if ($row["BIO_DEFORMATION"] == "06") { echo "selected='selected'"; } ?>>06 ความบกพร่องทางการพูดและภาษา</option>
                      <option value="07" <? if ($row["BIO_DEFORMATION"] == "07") { echo "selected='selected'"; } ?>>07 มีปัญหาทางพฤติกรรมหรืออารมณ์</option>
                      <option value="08" <? if ($row["BIO_DEFORMATION"] == "08") { echo "selected='selected'"; } ?>>08 ออทิสติก</option>
                      <option value="09" <? if ($row["BIO_DEFORMATION"] == "09") { echo "selected='selected'"; } ?>>09 พิการซ้อน</option>
                    </select>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left"><input type="text" name="bio_internal_phone" id="bio_internal_phone" maxlength="15" style="width: 100px; "  class="input_text" value="<?= $row["BIO_INTERNAL_PHONE"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'chief' && $_SESSION['EMP_ID'] != $_SESSION['USER_EMP_ID']) { ?> disabled="disabled" <?php } ?>/></td>
                </tr>
                ...
                if ($_SESSION['USER_TYPE'] != 'chief' || $_SESSION['USER_EMP_ID'] == $_SESSION['EMP_ID']) {
                  ...
                  <tr height="33">
                    ...
                    <td align="left" valign="middle" style="color:#663; font-size:11px">
                      <div id="show_upload3">
                        ...
                        if ($row["BIO_PIC_FILE"] == "") {
                          ?>
                          <input type="file" name="bio_pic_file" id="bio_pic_file" class="b_gray" <?php if ($_SESSION['USER_TYPE'] == 'user' && is_file('files/bio_data_file/'.$row["BIO_PIC_FILE"])==true) { ?> onfocus="myDisable(this)"<?php } ?> />
                  ...
                  <tr>
                    ...
                    <td align="left"  style="color:#663; font-size:11px">
                      ...
                      ?>
                      <div style="color:#F00; font-size:14px;">* รูปถ่าย ขนาดกว้าง 4 cm. x สูง 5 cm.  / ไฟล์นามสกุล .jpg, .bmp, .png  เท่านั้น<br />
                      * ขนาดไฟล์ ไม่น้อยกว่า 250 – 300 Pixel<br />
                      * รูปถ่ายหน้าตรง ฉากหลังสีพื้น เช่น สีฟ้า สีขาว ที่สามารถมองเห็นใบหน้าได้ชัดเจน<br />
                      * ห้ามสวมแว่นตา</div>
                    </td>
                  </tr>
...
$(function() {
	...
	$( "#auto_bio_nation1" ).autocomplete({
		source: function( request, response ) {
			$.ajax({
					/*url: "http://ws.geonames.org/searchJSON",*/
					url : "_find_nation_json1.php",
					dataType: "json",
					data: {
						featureClass: "P",
						style: "full",
					...
					success: function( data ) {
						...
						response( $.map( data.geonames, function( item ) {
							//alert(item);
							return {
								label: item.NATION_NAME_TH+" ("+item.NATION_NAME_ENG+")",
								value: item.NATION_NAME_TH,
								value2 : item.NATION_ID
							}
		...
		select: function( event, ui ) {
			$("#bio_nation1").val(ui.item.value2);
		},
		open: function() {
	...
	$( "#auto_bio_nation2" ).autocomplete({
		...
		minLength: 2,
		select: function( event, ui ) {
			$("#bio_nation2").val(ui.item.value2);
		},
		open: function() {
			$( this ).removeClass( "ui-corner-all" ).addClass( "ui-corner-top" );
		},
