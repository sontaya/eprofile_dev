...
function show_report(type){
	...
	var path = "salary_report"+type+".php";
	window.open(path,"salary"+type,"width=1400,height=700,scrollbars=1,resizable=1");
...
<option value="1">สรุปเงินเดือนบุคคลากร</option>
<option value="2">บัญชีถือจ่ายเงินเดือนอาจารย์ประจำตามสัญญาจ้าง</option>
<option value="3">บัญชีถือจ่ายเงินเดือนเจ้าหน้าที่ประจำตามสัญญาจ้าง</option>
<option value="4">บัญชีถือจ่ายเงินเดือน</option>
</select>
</td></tr>
