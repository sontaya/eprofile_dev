...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>ข้อมูลบุคลากรสายสนับสนุนมหาวิทยาลัยราชภัฎสวนดุสิต</title>
    <script type="text/javascript" src="../js/jquery.min.js"></script>
    <link rel="stylesheet" type="text/css" href="../css/purple/jquery-ui-1.8.10.custom.css" />
    ...
    <script type="text/javascript">
      ...
      function openModal(table){
        $("#dialog").load("summary_ref_table.php", { 'table': table } );
        $("#dialog" ).dialog( "open" );
      }
    </script>
    <style type="text/css">
  ...
  <body>
    <div align="center" style="font-size:14px;" >ข้อมูลบุคลากรสายสนับสนุนมหาวิทยาลัยราชภัฎสวนดุสิต <br /><br /> ปีการศึกษา <? echo date("Y") + 543; ?><br /><br /> ข้อมูล ณ วันที่ <? echo date("d") . " " . get_month_full(date("m")) . " " . (date("Y") + 543); ?><br />
      <br />
    </div>
    <table  cellspacing="0" cellpadding="2" class="all_table" align="center">
      <tr>
        ...
        <td height="33" colspan="4" align="center" valign="middle" class="th">ข้าราชการ</td>
        <td colspan="4" align="center" valign="middle" class="th">อาจารย์ประจำตามสัญญาจ้าง</td>
        <td colspan="4" align="center" valign="middle" class="th">พนักงานมหาวิทยาลัย</td>
        <td colspan="4" align="center" valign="middle" class="th">พนักงานราชการ</td>
        <td colspan="4" align="center" valign="middle" class="th2">รวมบุคลากรทั้งหมด</td>
      </tr>
      <tr>
    ...
    <div align="center"> <input type="button" value="Export to Excel" onclick="window.location = 'sdu_report_excel.php?excel=1'"/></div>
...
function count_person($where) {
  ...
  global $conn;
  $sql = "SELECT count(*) as num FROM sdu_education_support WHERE  $where ";
