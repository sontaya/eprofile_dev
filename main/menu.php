...
<? if ($menu_header[1]) { ?>
  ...
  <? if ($menu[1]) { ?>
      ...
      <? if ($menu[41]) { ?>
        <li ><a onclick="change_color(41);change_data('change_code.php','../images/no.png');" id="menu41">เปลี่ยนหมายเลขบุคลากร</a></li>
      <? } ?>
      <? if ($menu[44]) { ?>
...
<? } ?>
  ...
  <? if ($menu[23]) { ?>
      ...
      <? } ?>
      <? if ($menu[24]) { ?>
        <li ><a onclick="change_color(24);change_data('sector_transfer.php','../images/head2/work_data/sector_trnfer.png');"  id="menu24">ข้อมูลการย้ายสังกัด/เปลี่ยนสถานที่ปฏิบัติงาน/ช่วยปฏิบัติงาน/เปลี่ยนตำเเหน่ง</a></li>
      <? } ?>
       <? if ($menu[24]) { ?>
        <li ><a onclick="change_color(24);change_data('define_manage.php','../images/head2/work_data/define_manage.png');"  id="menu24">ข้อมูลการเเต่งตั้งตำเเหน่งทางการบริหาร</a></li>
      <? } ?>
       <? if ($menu[24]) { ?>
        <li ><a onclick="change_color(24);change_data('change_job.php','../images/head2/work_data/change_job.png');"  id="menu24">ข้อมูลการปรับเปลี่ยนตำเเหน่ง/สายงาน/เงินเดือน</a></li>
      <? } ?>
        <? if ($menu[24]) { ?>
        <li ><a onclick="change_color(24);change_data('data_answer.php','../images/head2/work_data/data_answer_new.png');"  id="menu24">ข้อมูลผลการประเมินการปฏิบัติงาน</a></li>
      <? } ?>
         <? if ($menu[24]) { ?>
        <li ><a onclick="change_color(24);change_data('estimate_service.php','../images/head2/work_data/estimate_service.png');"  id="menu24">ข้อมูลการประเมินผลการปฏิบัติราชการ</a></li>
      <? } ?>
      <? if ($menu[25]) { ?>
...
<? } ?>
  ...
  <? if ($menu_header[6]) { ?>
    ...
    <ul class="submenu" >
  <? if ($menu[42]) { ?>
        <li ><a onclick="change_color(42);change_data('../salery/s1.php','');"  id="menu42" >รายงานเปรียบเทียบเงินเดือน</a></li>
      <? } ?>
      <!--
      <? if ($menu[43]) { ?>
...
<? if ($menu_header[6]) { ?>
  <div class="headerbar" >คำร้อง</div>
  <ul class="submenu" >
  <? if ($menu[45]) { ?>
        <li ><a onclick="change_color(32);change_data('../request/request.php','../images/head2/report/re1.png');"  id="menu32">คำร้องขอปรับปรุงข้อมูล</a></li>

<? } ?>

	 <? if ($menu[46]) { ?>
        <li ><a onclick="change_color(32);change_data('../request/request_search.php','../images/head2/report/re2.png');"  id="menu32">รายการคำร้องขอปรับปรุงข้อมูล</a></li>
...
<? if ($_SESSION['EMP_ID']=='2010-069'|| $_SESSION['EMP_ID']=='2055-003' || $_SESSION['EMP_ID']=='2020-053' || $_SESSION['EMP_ID']=='2020-012' || $_SESSION['EMP_ID']=='2010-047' || $_SESSION["EMP_ID"]=='2020-052' || $_SESSION['EMP_ID']=='2010-001') { ?>
  <div class="headerbar" >ข้อมูลการลงเวลาปฏิบัติงาน</div>
  <ul class="submenu" >
  <? if ($menu[47]) { ?>
        <li ><a onclick="change_color(32);change_data('timestamp_log.php','../images/head2/regis_form/timestamp.jpg');"  id="menu32">ตรวจสอบการลงเวลา</a></li>
<? } ?>
<?
...
?>
  <? if ($menu[48]) { ?>
       <li ><a onclick="change_color(32);change_data('timestamp_list.php','../images/head2/report/re2.png');"  id="menu32">รายชื่อภายในองค์กร</a></li>
<? } ?>
<?
}
?>
