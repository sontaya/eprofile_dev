...
if($what_form == "1"){
	...
	if($id == "" or $id == null){
		$new_id = auto_increment("ID","SDU_POSSUB_ACH1_TAB");
		$result=$db->add_db("SDU_POSSUB_ACH1_TAB",array(
											  "ID" => "$new_id",
 											  "EMP_ID"=>"$emp_id",
	...
	$type_update = "1";
		...
		$result=$db->update_db("SDU_POSSUB_ACH1_TAB",array(
											  "COURSE_NAME"=>"$course_name",
											  "COURSE_YEAR"=>"$course_year",
											  "TYPE"=>"$type",
											  "COOP"=>"$coop",
...
////////////////ตำรา////////////////////////	
	...
	if($id == "" or $id == null){
		$new_id = auto_increment("ID","SDU_POSSUB_ACH2_TAB");
		$result=$db->add_db("SDU_POSSUB_ACH2_TAB",array(
											  "ID" => "$new_id",
 											  "EMP_ID"=>"$emp_id",
											  "POSITION_TYPE"=>"$position_type",
		...
		$result=$db->update_db("SDU_POSSUB_ACH2_TAB",array(
											  "TBOOK_NAME_TH"=>"$tbook_name_th",
											  "TBOOK_NAME_EN"=>"$tbook_name_en",
											  "TBOOK_NAME_OTH"=>"$tbook_name_oth",
											  "TBOOK_NAME_OTH2"=>"$tbook_name_oth2",
...
////////////////หนังสือ////////////////////////			
	...
	if($id == "" or $id == null){
		$new_id = auto_increment("ID","SDU_POSSUB_ACH3_TAB");
		$result=$db->add_db("SDU_POSSUB_ACH3_TAB",array(
											  "ID" => "$new_id",
 											  "EMP_ID"=>"$emp_id",
											  "POSITION_TYPE"=>"$position_type",
	...
	$type_update = "1";
		...
		$result=$db->update_db("SDU_POSSUB_ACH3_TAB",array(
											  "BOOK_NAME_TH"=>"$book_name_th",
											  "BOOK_NAME_EN"=>"$book_name_en",
											  "BOOK_NAME_OTH"=>"$book_name_oth",
											  "BOOK_NAME_OTH2"=>"$book_name_oth2",
...
////////////////ผลงานวิจัย////////////////////////				
	...
	if($id == "" or $id == null){
		$new_id = auto_increment("ID","SDU_POSSUB_ACH4_TAB");
		$result=$db->add_db("SDU_POSSUB_ACH4_TAB",array(
											  "ID" => "$new_id",
 											  "EMP_ID"=>"$emp_id",
											  "POSITION_TYPE"=>"$position_type",
	...
	$type_update = "1";
		...
		$result=$db->update_db("SDU_POSSUB_ACH4_TAB",array(
											  "RESEARCH_NAME_TH"=>"$research_name_th",
											  "RESEARCH_NAME_EN"=>"$research_name_en",
											  "RESEARCH_NAME_OTH"=>"$research_name_oth",
											  "RESEARCH_NAME_OTH2"=>"$research_name_oth2",
...
////////////////บทความ////////////////////////		
	...
	$press_year = $_POST["press_year"];
	if($id == "" or $id == null){
		$new_id = auto_increment("ID","SDU_POSSUB_ACH5_TAB");
		$result=$db->add_db("SDU_POSSUB_ACH5_TAB",array(
											  "ID" => "$new_id",
 											  "EMP_ID"=>"$emp_id",
											  "POSITION_TYPE"=>"$position_type",
		...
		$result=$db->update_db("SDU_POSSUB_ACH5_TAB",array(
											  "ARTICLE_NAME_TH"=>"$article_name_th",
											  "ARTICLE_NAME_EN"=>"$article_name_en",
											  "ARTICLE_NAME_OTH"=>"$article_name_oth",
											  "ARTICLE_NAME_OTH2"=>"$article_name_oth2",
...
////////////////ผลงานวิชาการลักษณะอื่นๆ////////////////////////			
	...
	if($id == "" or $id == null){
		$new_id = auto_increment("ID","SDU_POSSUB_ACH6_TAB");
		$result=$db->add_db("SDU_POSSUB_ACH6_TAB",array(
											  "ID" => "$new_id",
 											  "EMP_ID"=>"$emp_id",
											  "POSITION_TYPE"=>"$position_type",
		...
		$result=$db->update_db("SDU_POSSUB_ACH6_TAB",array(
											  "ACHEIVE_TYPE"=>"$acheive_type",
											  "ACHEIVE_NAME_TH"=>"$acheive_name_th",
											  "ACHEIVE_NAME_EN"=>"$acheive_name_en",
											  "ACHEIVE_NAME_OTH"=>"$acheive_name_oth",
	...
	$db->closedb($conn);	
		if($result){
			...
			window.top.load_ach_sub_list(<?=$position_type?>);
			</script>
			<?
