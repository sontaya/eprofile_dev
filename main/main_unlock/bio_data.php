              ...
              <table width="100%">
                <? if ($_SESSION['USER_TYPE'] != 'chief' || $_SESSION['USER_EMP_ID'] == $_SESSION['EMP_ID']) { ?>
                    ...
                    <td>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="18%"><input type="text"  name="bio_id_from" id="bio_id_from" style="width: 100px; " class="input_text" value="<?= $row["BIO_ID_FROM"]; ?>"<?php if ( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?> /></td>
                  ...
                  <tr>
                    ...
                    <td align="left"><input type="text" name="bio_tax_id" id="bio_tax_id" style="width: 120px; "  class="input_text" value="<?= $row["BIO_TAX_ID"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                  </tr>
                  <tr>
                    <td align="right" class="form_text">เลขที่บัตรข้าราชการ :</td>
                    <td align="left"><input type="text" name="bio_gov_id" id="bio_gov_id" style="width: 100px; "  class="input_text" onkeyup="//chkNum('bio_gov_id','OnlyNm');" value="<?= $row["BIO_GOV_ID"]; ?>"<?php if ( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                  </tr>
                  <tr>
                    <td align="right" class="form_text">วันออกบัตร :</td>
                    <td>
