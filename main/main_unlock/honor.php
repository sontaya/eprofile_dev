...
<table cellpadding="0" cellspacing="0" align="center" width="758">
    ...
    <div align="center"  id="toggle_form"><?php if( $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/add.png" onclick="toggle_form('honor','hon_id')" style="cursor:pointer"/><?php } ?>&nbsp;</div>
    ...
    <table width="758" border="0" cellspacing="4" cellpadding="4">
      <tr>
        ...
        <td width="548" align="left">
          <select id="hon_year" name="hon_year"<?php if( $_SESSION['USER_TYPE'] == 'chief') {?> onfocus="myDisable(this);"<?php } ?>>
      ...
      <tr>
        ...
        <td align="left">
        <input type="text" name="hon_name" id="hon_name" style="width: 300px;" class="input_text"<?php if( $_SESSION['USER_TYPE'] == 'chief') {?> onfocus="myDisable(this);"<?php } ?>/>
     ...
     <tr>
        ...
        <td align="left"><input type="file" name="hon_file" id="hon_file" class="file_upload"<?php if( $_SESSION['USER_TYPE'] == 'chief') {?> onfocus="myDisable(this);"<?php } ?>/><input type='text' id='hid_hon_file' name='hid_hon_file' style="display:none" /></td>
      </tr>
      <tr>
        <td align="right" >&nbsp;</td>
        <td align="left">&nbsp;</td>
