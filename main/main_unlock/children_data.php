                     ...
                     <form id="children_data" name="children_data" enctype="multipart/form-data" method="post" action="children_data_save.php"  target="upload_target">
                        <table width="100%" border="0" cellspacing="4" cellpadding="4">
                           ...
                           <tr>
                              ...
                              <td colspan="2" align="left"><input type="text"  style="width: 25px; border:none; " readonly="readonly" name="chl_s_year" id="chl_s_year" onfocus="Age('chl_birthday','chl_s_year','chl_s_month')"<?php if ( $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> ปี <input type="text"  style="width: 25px; border:none; " readonly="readonly" name="chl_s_month" id="chl_s_month" onfocus="Age('chl_birthday','chl_s_year','chl_s_month')"<?php if ($_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> เดือน</td>
                           </tr>
                           <tr>
