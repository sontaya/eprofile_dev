...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div align="center" style="font-size:14px;" >ข้อมูลบุคลากรสายวิชาการมหาวิทยาลัยราชภัฎสวนดุสิต <br /><br /> ปีการศึกษา <? echo date("Y") + 543; ?><br /><br /> ข้อมูล ณ วันที่ <? echo date("d") . " " . get_month_full(date("m")) . " " . (date("Y") + 543); ?><br />
      <br />
    </div>
