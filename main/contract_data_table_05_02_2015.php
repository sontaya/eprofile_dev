...
<table width="90%"  border="0" align="center"  bgcolor="#e9e9e9" >
    <tr align="center"  class="text_th">
        ...
        <td width="20%" class="text_tr">เลขที่สัญญา</td>
        <td width="20%" class="text_tr">สัญญาระยะที่</td>
        <td width="20%" class="text_tr">ตำเเหน่งปัจุบัน</td>
    ...
    <tr align="center" height="20" valign="top">
        ...
        <td align="left" class="text_td text_data"><?=$row["CONTRACT_PERIOD"]?></td>
