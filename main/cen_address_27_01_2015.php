 ...
 <tr>
    ...
    <table width="758" border="0" cellspacing="4" cellpadding="4">
      <tr>
        ...
        <td colspan="2" align="left"><input type="text" name="ca_house_no" id="ca_house_no" style="width: 100px; " class="input_text" value="<?=$row["CA_HOUSE_NO"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">หมู่ :</td>
        <td colspan="2" align="left"><input type="text" name="ca_moo" id="ca_moo" style="width: 80px; " class="input_text" value="<?=$row["CA_MOO"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">ตึก/อาคาร :</td>
        <td colspan="2" align="left"><input type="text" name="ca_building" id="ca_building" style="width: 120px; " class="input_text" value="<?=$row["CA_BUILDING"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">หมู่บ้าน :</td>
        <td colspan="2" align="left"><input type="text" name="ca_village" id="ca_village" style="width: 120px; " class="input_text" value="<?=$row["CA_VILLAGE"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">ห้อง :</td>
        <td colspan="2" align="left"><input type="text" name="ca_room" id="ca_room" style="width: 120px; " class="input_text" value="<?=$row["CA_ROOM"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">ซอย :</td>
        <td colspan="2" align="left"><input type="text" name="ca_soi" id="ca_soi" style="width: 120px; " class="input_text" value="<?=$row["CA_SOI"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">ถนน :</td>
        <td colspan="2" align="left"><input type="text" name="ca_road" id="ca_road" style="width: 120px; " class="input_text" value="<?=$row["CA_ROAD"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
	...
	/*	}else{
      ...
      <tr>
        ...
        <td width="130" align="left"><input type="text" name="cu_house_no" id="cu_house_no" style="width: 100px;" class="input_text" value="<?=$row["CU_HOUSE_NO"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/>
        &nbsp; &nbsp;</td>
      ...
      <tr>
        <td align="right" class="form_text">หมู่ :</td>
        <td colspan="2" align="left"><input type="text" name="cu_moo" id="cu_moo" style="width: 80px;" class="input_text" value="<?=$row["CU_MOO"]?>"<?php if($_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">ตึก/อาคาร :</td>
        <td colspan="2" align="left"><input type="text" name="cu_building" id="cu_building" style="width: 120px;" class="input_text" value="<?=$row["CU_BUILDING"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">หมู่บ้าน :</td>
        <td colspan="2" align="left"><input type="text" name="cu_village" id="cu_village" style="width: 120px;" class="input_text" value="<?=$row["CU_VILLAGE"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">ห้อง :</td>
        <td colspan="2" align="left"><input type="text" name="cu_room" id="cu_room" style="width: 120px;" class="input_text" value="<?=$row["CU_ROOM"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">ซอย :</td>
        <td colspan="2" align="left"><input type="text" name="cu_soi" id="cu_soi" style="width: 120px;" class="input_text" value="<?=$row["CU_SOI"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
        <td align="right" class="form_text">ถนน :</td>
        <td colspan="2" align="left"><input type="text" name="cu_road" id="cu_road" style="width: 120px;" class="input_text" value="<?=$row["CU_ROAD"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
      <tr>
    ...
    -->
      ...
      <tr>
        <td align="right" class="form_text">* รหัสไปรษณีย์ :</td>
        <td colspan="2" align="left"><input type="text" name="cu_post_code" id="cu_post_code" style="width: 50px;" maxlength="5" class="input_text" value="<?=$row["CU_POST_CODE"]?>"<?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
      </tr>
        <tr>
        <td align="right" class="form_text">ประเทศ :</td>
        <td colspan="2" align="left">
