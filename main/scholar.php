...
<!--                            <option value="">เลือก</option>
                    ...
                    <td align="left">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left" class="form_text">
                          <input type="radio" name="fund_money" id="fund_money" value="1" <? if ($row["FUND_MONEY"] == "1") { echo "checked='checked' "; } ?> onClick="document.getElementById('fund_other').disabled=true;"/>ส่วนตัว
                          <input type="radio" name="fund_money" id="fund_money" value="2" <? if ($row["FUND_MONEY"] == "2") { echo "checked='checked' "; } ?> onClick="document.getElementById('fund_other').disabled=false;"/>อื่น ๆ <input type="text" name="fund_other" id="fund_other" disabled class="input_text" ></td>
                      </tr>
					  <!--
                      <tr>
                      ...
                      <tr>
                        ...
                        <td width="365" align="left" class="form_text">วันที่อนุมัติ  :
						  ...
						  <tr>
                            ...
                            <td colspan="2" align="left" class="form_text">
                              <input type="text" name="sch_start_new" id="sch_start_new" style="width: 80px; " class="input_text" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly<?php } ?>/> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('sch_start_new','YYYY-MM-DD')"  style="cursor:pointer"/> คำสั่ง <input type="text" name="sch_start_order_on" id="sch_start_order_on" class="input_text" style="width: 80px; " > ที่ <input type="text" name="sch_start_at_on" id="sch_start_at_on" class="input_text" style="width: 80px; " > ลง ณ วันที่ <input type="text" name="sch_start_at_date" id="sch_start_at_date" style="width: 80px; " class="input_text"> <img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('sch_start_at_date','YYYY-MM-DD')"  style="cursor:pointer"/><?php } ?> 
                          ...
                          <tr>
                            ...
                            <td colspan="2" align="left" class="form_text">
                              ...
                              <input type="hidden" name="new_munny_old" id="new_munny" class="new_munny_old"><br /><br />
                               คำสั่ง <input type="text" name="sch_money_order_on" id="sch_money_order_on" class="input_text" style="width: 80px; " > ที่ <input type="text" name="sch_money_at_on" id="sch_money_at_on" class="input_text" style="width: 80px; " > ลง ณ วันที่ <input type="text" name="sch_money_at_date" id="sch_money_at_date" style="width: 80px; " class="input_text" readonly> <img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('sch_money_at_date','YYYY-MM-DD')"  style="cursor:pointer"/>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td align="right" valign="top" class="form_text">แนบไฟล์ :</td>
                            <td colspan="2" align="left" valign="top">
                              <input type="file" id="sch_edu_file" name="sch_edu_file" /><input type="hidden" id="sch_edu_old_file" name="sch_edu_old_file"/>
                            </td>
                          </tr>
						<!---------- --------->
...
//	}
              ...
              <? include "sch_b3.php"; ?>
                        ...
                        <div id="tabs-4" align="center" >
                          ...
                          <div align="center"><img src="../images/add.png" onclick="toggle_form('contract_extend','',this,'#data_form4'); clear_data_ajax();" style="cursor:pointer"/></div>
                          <div id="data_form4" style="display:none;">
                            <form id="contract_extend" name="contract_extend" method="post" action="sch_extend_save.php" target="upload_target">
                              ...
                              <tr>
                                <td align="right">วันที่กลับเข้าปฏิบัติงาน</td>
                                <td align="left"><input type="text"  name="ex_start_date_return" id="ex_start_date_return" style="width: 80px; " class="input_text" readonly/> <img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('ex_start_date_return','YYYY-MM-DD')"  style="cursor:pointer"/> คำสั่ง <input type="text"  name="ex_start_return_order" id="ex_start_return_order" style="width: 80px; " class="input_text" /> ที่ <input type="text"  name="ex_start_return_order_no" id="ex_start_return_order_no" style="width: 80px; " class="input_text" /> <input type="text"  name="ex_start_return_date" id="ex_start_return_date" style="width: 80px; " class="input_text" readonly/> <img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('ex_start_return_date','YYYY-MM-DD')"  style="cursor:pointer"/></td>
                              </tr>
                              <tr>
                                <td align="right">&nbsp;</td>
                                <td align="left">&nbsp;</td>
                         ...
                         <div id="tabs-5" align="center" >
                          ...
                          <img src="../images/bg_d.png" style="margin-left:10px;" width="640" />
                            <table  cellspacing="0" cellpadding="0" align="center" >
                              <tr>
                                <td>
                                  <form id="money_fund" name="money_fund" method="post" action="add_money_fund_save.php" target="upload_target" enctype="multipart/form-data">
                                    <table width="758" border="0" cellspacing="4" cellpadding="4">
                                      <tr>
                                        <input type="hidden" id="money_fund_id" name="money_fund_id" value="">
                                            ...
                                            <tr>
                                                <td align="right" class="form_text">เอกสารแนบ :</td>
                                                <td align="left"><input type="file" name="file_money_fund" id="file_money_fund" style="width: 100px; " class="int_text"/><input type="hidden" name="file_old_money_fund" id="file_old_money_fund" /></td>
                                            </tr>
                         ...
                         <div id="tabs-6" align="center">
                          ...
                          <p>
                             <table  cellspacing="0" cellpadding="0" align="center" >
                              <tr>
                                <td>
                                  <form id="pay_fund" name="pay_fund" method="post" action="pay_fund_data_save.php" target="upload_target" enctype="multipart/form-data">
                                    <table width="758" border="0" cellspacing="4" cellpadding="4">
                                      <tr>
                                        <input type="hidden" id="pay_fund_id" name="pay_fund_id" value="">
                                            ...
                                            <tr>
                                                <td align="right" class="form_text">เอกสารแนบ :</td>
                                                <td align="left"><input type="file" name="file_munny" id="file_munny" style="width: 100px; " class="int_text"/><input type="hidden" name="file_old_munny" id="file_old_munny"/></td>
                                            </tr>
