...
header("Content-Disposition: attachment; filename=almost_graduation_v_report_".date("d-m-").(date("Y") +543).".xls;");
...
while($row_all_person1 = oci_fetch_array($stid_all_person1, OCI_BOTH)){
	...
	if($all_person_temp1 > 0 ){
		...
		$num1_all_temp21 =  $db->count_row(TB_CURRENT_WORK_TAB," WHERE  EMP_ID = '".$row_all_person1["EMP_ID"]."' AND   CWK_MUA_VPOS = '04' AND  CWK_MUA_EMP_TYPE = '1' AND CWK_MUA_MAIN = '02'  AND CWK_STATUS <> '02' AND CWK_STATUS <> '03'  AND CWK_STATUS <> '04' AND CWK_STATUS <> '07'   ");
...
while($row_all_person1 = oci_fetch_array($stid_all_person1, OCI_BOTH)){
	...
	if($all_person_temp1 > 0 ){
		...
		$num1_all_temp46 =  $db->count_row(TB_CURRENT_WORK_TAB," WHERE  EMP_ID = '".$row_all_person1["EMP_ID"]."' AND   CWK_MUA_VPOS = '04' AND  CWK_MUA_EMP_TYPE = '4' AND CWK_MUA_MAIN = '15'  AND CWK_STATUS <> '02' AND CWK_STATUS <> '03'  AND CWK_STATUS <> '04' AND CWK_STATUS <> '07'   ");
...
while($row_all_person1 = oci_fetch_array($stid_all_person1, OCI_BOTH)){
	...
	if($all_person_temp1 > 0 ){
		...
		$num1_all_temp88 =  $db->count_row(TB_CURRENT_WORK_TAB," WHERE  EMP_ID = '".$row_all_person1["EMP_ID"]."' AND   CWK_MUA_VPOS = '04' AND  CWK_MUA_EMP_TYPE = '2' AND CWK_MUA_MAIN = '17'  AND CWK_STATUS <> '02' AND CWK_STATUS <> '03'  AND CWK_STATUS <> '04' AND CWK_STATUS <> '07'   ");
...
while($row_all_person1 = oci_fetch_array($stid_all_person1, OCI_BOTH)){
	...
	if($all_person_temp1 > 0 ){
		...
		while($row_query1 = oci_fetch_array($stid_query1, OCI_BOTH)){
			...
			$num2_all_temp19 =  $db->count_row(TB_SCHOLAR_TAB," WHERE  EMP_ID = '".$row_query1["EMP_ID"]."' AND  SCH_EDU_LEVEL = '1' ");
		...
		while($row_query3 = oci_fetch_array($stid_query3, OCI_BOTH)){
			...
			$num2_all_temp59 =  $db->count_row(TB_SCHOLAR_TAB," WHERE  EMP_ID = '".$row_query3["EMP_ID"]."' AND  SCH_EDU_LEVEL = '1' ");
