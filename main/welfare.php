...
<tr><td width="20" align="left" valign="middle" > <input type="checkbox" name="sso" value="1" <? if($row['SSO'] == "1") echo "checked='checked'";?><?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /></td>
<td width="629" height="30" colspan="2" align="left" valign="middle"> ประกันสังคม ใช้สิทธ์โรงพยาบาล <input type="text" id="hospital" name="hospital" class="input_text" value="<?=$row['HOSPITAL']?>"<?php if($_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /></td></tr>

<tr><td width="20" align="left" valign="middle" > <input type="checkbox" name="cpk" value="1" <? if($row['CPK'] == "1") echo "checked='checked'";?><?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /></td><td width="629" height="30" colspan="2" align="left" valign="middle"> ชพค.</td></tr>

<tr><td width="20" align="left" valign="middle" > <input type="checkbox" name="cps" value="1" <? if($row['CPS'] == "1") echo "checked='checked'";?><?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /></td><td width="629" height="30" colspan="2" align="left" valign="middle"> ชพส.</td></tr>
   <tr><td width="20" align="left" valign="middle" > <input type="checkbox" name="gpf" value="1" <? if($row['GPF'] == "1") echo "checked='checked'";?><?php if($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /></td>
   <td width="629" height="30" colspan="2" align="left" valign="middle"> สมาชิก กบข.</td></tr>
    <tr><td align="left" valign="middle" > <input type="checkbox" name="gpef" value="1" <? if($row['GPEF'] == "1") echo "checked='checked'";?><?php if($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>/></td>
    <td height="30" colspan="2" align="left" valign="middle"> สมาชิก กสจ. </td></tr>
    <tr><td align="left" valign="middle" ><input type="checkbox" name="personnel_fund" value="1" <? if($row['PERSONNEL_FUND'] == "1") echo "checked='checked'";?><?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /></td>
  <td height="30" colspan="2" align="left" valign="middle"> กองทุนสะสมเลี้ยงชีพสำหรับบุคลากร</td></tr>
    <tr><td align="left" valign="middle" ><input type="checkbox" name="provident_fund" value="1" <? if($row['PROVIDENT_FUND'] == "1") echo "checked='checked'";?><?php if( $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /></td>
  <td height="30" colspan="2" align="left" valign="middle"> กองทุนสำรองเลี้ยงชีพ</td></tr>
