...
<div align="center"> <input type="button" value="Export to Excel" onclick="window.location = 'scholar_report4_excel.php?excel=1&date1=<?=$_REQUEST["date1"]?>&date2=<?=$_REQUEST["date2"]?>'"/></div>
