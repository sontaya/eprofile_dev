...
header("Content-Disposition: attachment; filename=finish_education_report_".date("d-m-").(date("Y") +543).".xls;");
...
<table width="1343" border="1" cellspacing="0" cellpadding="3">
  <tr>
    ...
    <th width="133" align="center">วันสำเร็จการศึกษา</th>
    <th width="91" align="center">วันเริ่มศึกษา</th>
