...
while (($row = oci_fetch_array($stid, OCI_BOTH))) {
	...
	$n++;
echo "\n<tr bgcolor='".$bgcolor."'><td>$n.</td><td width='350' align='left'><samp style='cursor:pointer' title='เลือก' onclick=\"pick_location2('$n')\"> ตำบล".$row['NAME_REF_TUMBON']."<input type='hidden' id='t$n' value='".$row['CODE_REF_TUMBON']."' ><input type='hidden' id='n1$n' value='".$row['NAME_REF_TUMBON']."' >";
//echo "<br />";
echo " ";
