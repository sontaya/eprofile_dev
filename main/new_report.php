...
function show_report(type){
	...
	var path = "new_report"+type+".php";
	window.open(path,"quit"+type,"width=1400,height=700,scrollbars=1,resizable=1");
...
<option value="1">สรุปการจ้างบุคคลากร</option>
<option value="2">สถิติการบรรจุบุคลากร</option>
</select>
</td></tr>
