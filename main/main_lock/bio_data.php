  ...
  function pop_history_name() {
	...
	function chack_idcard(){
		...
		if(idcard!=idcard_old){
			$.post("ajax_chack_idcard.php?r="+ran, {idcard:idcard}, 
				function(data){
					//alert(idcard+" : "+data);
					chk_card=data;
				}
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="17%">
                          ...
                          -->
                          <input type="text" name="bio_title2_th" id="bio_title2_th" style="width: 80px; " class="input_text"  onkeyup="chkTh('bio_title2_th','OnlyThai');" value="<?= $row["BIO_TITLE2_TH"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?> />
                        </td>
...
?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?> /></td>
                        <td width="19%" align="right" class="form_text">ชื่อกลาง :&nbsp;&nbsp;</td>
                        <td width="18%" align="left"><input type="text" name="bio_mname_th" id="bio_mname_th" style="width: 80px; " class="input_text"   value="<?= $row["BIO_MNAME_TH"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?> /></td>
...
?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                        ...
                        <td width="15%" align="left">&nbsp;<input type="text" name="bio_mname_en" id="bio_mname_en" style="width: 80px; " class="input_text" onkeyup="chkEn('bio_mname_en','OnlyEn');" value="<?= $row["BIO_MNAME_EN"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
...
?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                      ...
                      <tr>
                        <td width="33%" align="left">
                          ...
                          <!--<select name="bio_nation1" id="bio_nation1"  style="width: 130px" >-->
                            ...
                            <input type="text" class="input_text" readonly="readonly" value="<?= $name_country ?>" style="width: 130px;"  <?php if ($_SESSION['USER_TYPE'] != 'admin' && $_SESSION['USER_TYPE'] != 'hr') { ?> onfocus="myDisable(this)"<?php } ?><?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?><?php } ?>/>
                        ...
                        <td width="36%" align="left">
                          ...
                          <!--<select name="bio_nation2" class="b_gray" id="bio_nation2" style="width: 130px" <?php if ($_SESSION['USER_TYPE'] != 'admin' && $_SESSION['USER_TYPE'] != 'hr') { ?>onfocus="myDisable(this)"<?php } ?><?php if (($_SESSION['USER_TYPE'] == 'user') || $_SESSION['USER_TYPE'] == 'chief') { ?><?php } ?>>
                            ...
                            <input type="text" class="input_text" readonly="readonly"  value="<?= $name_country ?>" />  
                ...
                <tr>
                  ...
                  <td align="left"><input name="bio_birthday" type="text" class="input_text"  id="bio_birthday" style="width: 128px; " value="<?= $bio_birthday ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?> />
                ...
                <? if ($_SESSION['USER_TYPE'] != 'chief' || $_SESSION['USER_EMP_ID'] == $_SESSION['EMP_ID']) { ?>
                  <tr>
                    ...
                    <td>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="22%" align="left"><input name="person_id" type="text" class="input_text" id="person_id" style="width: 128px; "  value="<?= $_SESSION["PERSON_ID"]; ?>" maxlength="20"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?> onkeyup="chack_idcard();" /></td>
                          <td width="17%" align="right" class="form_text">ออกให้ ณ : &nbsp;</td>
                          <td width="18%"><input type="text"  name="bio_id_from" id="bio_id_from" style="width: 100px; " class="input_text" value="<?= $row["BIO_ID_FROM"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?> /></td>
                          ...
                          <td width="30%">
                            ...
                            ?>
                            <select name="bio_id_from_p" id="bio_id_from_p" class="b_gray"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this)"<?php } ?>>
                  ...
                  <tr>
                    ...
                    <td align="left"><input type="text" name="bio_tax_id" id="bio_tax_id" style="width: 120px; "  class="input_text" value="<?= $row["BIO_TAX_ID"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                  </tr>
                  <tr>
                    <td align="right" class="form_text">เลขที่บัตรข้าราชการ :</td>
                    <td align="left"><input type="text" name="bio_gov_id" id="bio_gov_id" style="width: 100px; "  class="input_text" onkeyup="//chkNum('bio_gov_id','OnlyNm');" value="<?= $row["BIO_GOV_ID"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/></td>
                  </tr>
                  <tr>
                    <td align="right" class="form_text">วันออกบัตร :</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td align="left"><input type="text" name="bio_bank_acc_id" id="bio_bank_acc_id" style="width: 100px; "  class="input_text" onkeyup="chkNum('bio_bank_acc_id','OnlyNm');" value="<?= $row["BIO_BANK_ACC_ID"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/>
                      &nbsp; &nbsp;&nbsp; <span class="form_text">ธนาคาร :
                        <input type="text" name="bio_bank" id="bio_bank" style="width: 190px; "  class="input_text" value="<?= $row["BIO_BANK"]; ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly="readonly"<?php } ?>/>
                      </span></td>
                  </tr>
                <? } ?>
                <tr>
