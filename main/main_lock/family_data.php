...
$("select#fam_province").val($("#ca_province").html());*/ 
   ...
   function pick_nation5(id){
      ...
      $("span#nation5").html("<input type='hidden' value='"+id_nation+"' id='fam_country' name='fam_country' style='width: 130px' ><input type='text' value='"+name_nation+"' readonly='readonly'>");
...
<table cellpadding="0" cellspacing="0" align="center" width="758" >
   <tr><td >
         ...
         <div align="center"  id="toggle_form"><?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/add.png" onclick="toggle_form('family_data','')" style="cursor:pointer"/><?php } ?>&nbsp;</div>
                        ...
                        <table width="100%" border="0" cellspacing="4" cellpadding="4">
                           <tr>
                              ...
                              <td colspan="2" align="left" class="form_text">
                                 <select name="fam_relation" id="fam_relation"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                           ...
                           <tr>
                              ...
                              <td colspan="2" >
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="14%">
                                          <select name="fam_title_th" id="fam_title_th" onchange="swap_fam_title_th()"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                             <option value="0">เลือก</option>
                                       ...
                                       <td width="15%" align="left"><input type="text" name="fam_fname_th" id="fam_fname_th" style="width: 80px;" class="input_text" onkeyup="chkTh('fam_fname_th','OnlyThai');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="14%" align="right" class="form_text">ชื่อกลาง : &nbsp;</td>
                                       <td width="15%" align="left"><input type="text" name="fam_mname_th" id="fam_mname_th" style="width: 80px;" class="input_text" onkeyup="chkTh('fam_mname_th','OnlyThai');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?> /></td>
                                       <td width="13%" align="right" class="form_text">นามสกุล : &nbsp;</td>
                                       <td width="22%" class="form_text"><input type="text" name="fam_lname_th" id="fam_lname_th" style="width: 80px;" class="input_text" onkeyup="chkTh('fam_lname_th','OnlyThai');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?> /></td>
                                    </tr>
                                 </table></td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2">
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="12%">
                                          <select name="fam_title_en" id="fam_title_en" onchange="swap_fam_title_en()"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                             <option value="0">เลือก</option>
                                       ...
                                       <td width="15%" align="left"><input type="text" name="fam_fname_en" id="fam_fname_en" style="width: 80px;" class="input_text" onkeyup="chkEn('fam_fname_en','OnlyEn');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?> /></td>
                                       <td width="13%" align="right" class="form_text">Mname : &nbsp;</td>
                                       <td width="15%" align="left"><input type="text" name="fam_mname_en" id="fam_mname_en" style="width: 80px;" class="input_text" onkeyup="chkEn('fam_mname_en','OnlyEn');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?> /></td>
                                       <td width="13%" align="right" class="form_text">Lname : &nbsp;</td>
                                       <td width="21%"><input type="text" name="fam_lname_en" id="fam_lname_en" style="width: 80px;" class="input_text" onkeyup="chkEn('fam_lname_en','OnlyEn');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                    </tr>
                                 </table>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2" align="left" class="form_text"><input name="fam_sex" type="radio" id="fam_sex"  value="male"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>/>  ชาย <input type="radio" name="fam_sex" id="fam_sex" value="female"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?> />  หญิง</td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="30%" align="left">
                                          ...
                                          ?>
                                <span id="nation3"><!--<select name="fam_nation1" id="fam_nation1" style="width: 130px" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                             <?= $option_fam_nation1 ?>
                                       </select>-->
                                             <input type="hidden" name="fam_nation1" id="fam_nation1" value="<?= $row_fam_nation1["NATION_ID"] ?>" style="width: 130px" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> />
                                             <input type="text" name="fam_nation1" id="fam_nation1" readonly='readonly' style="width: 130px" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> value="<?= $name_country ?>" />
                                          </span><?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?> <img src="../images/search_icon.gif" width="25" border="0"  align="absmiddle" style="cursor:pointer" id="opener3"  title="ค้นหา"/><?php } ?>
                                       </td>
                                ...
                                <span id="nation4"><!--<select name="fam_nation2" id="fam_nation2" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                             ...
                                             <input type="hidden" name="fam_nation2" value="<?= $row_fam_nation2["NATION_ID"] ?>" id="fam_nation2" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> />
                                             <input type="text" readonly='readonly' style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> value="<?= $name_country ?>" />

                                          </span><?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?> <img src="../images/search_icon.gif" width="25" border="0"  align="absmiddle" style="cursor:pointer" id="opener4"  title="ค้นหา"/><?php } ?>
                           ...
                           <tr>
                              ...
                              <td colspan="2" align="left">
                                 ...
                                 ?>
                                 <select name="fam_religion" id="fam_religion" class="widthFix"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                    <?= $option_fam_religion ?>
                                 </select>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2" align="left"><input name="fam_birthday" onblur="Age('fam_birthday','fam_s_year','fam_s_month')" type="text" class="input_text" id="fam_birthday" style="width: 80px;"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?> /> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('fam_birthday','YYYY-MM-DD');$('#fam_birthday').focus()"  style="cursor:pointer"/><?php } ?> ex. 15/10/2553 
                                 &nbsp; &nbsp;สถานะ : <input name="fam_alive" type="radio" id="fam_alive" value="1" checked="checked"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /> มีชีวิต <input type="radio" id="fam_alive" name="fam_alive" value="2"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /> ถึงแก่กรรม  <input type="radio" id="fam_alive" name="fam_alive" value="3"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /> สาบสูญ</td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ปัจจุบันอายุ :</td>
                              <td colspan="2" align="left" class="form_text"><input type="text"  style="width: 25px; border:none;" readonly="readonly" class="input_text" name="fam_s_year" id="fam_s_year" onfocus="Age('fam_birthday','fam_s_year','fam_s_month')"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> ปี <input type="text"  style="width: 25px; border:none;" class="input_text" readonly="readonly" name="fam_s_month" id="fam_s_month" onfocus="Age('fam_birthday','fam_s_year','fam_s_month')"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> เดือน</td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">สถานภาพ : </td>
                              <td colspan="2" align="left"><select name="fam_status" id="fam_status"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                    <option value="0">เลือก</option>
                           ...
                           <tr>
                              ...
                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="22%" align="left"><input name="fam_code_id" type="text" class="input_text" id="fam_code_id" style="width: 120px;" onkeyup="chkNum('fam_code_id','OnlyNm');" maxlength="13"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="16%" align="right" class="form_text">ออกให้ ณ : &nbsp;</td>
                                       <td width="18%"><input type="text" name="fam_id_from" id="fam_id_from" style="width: 100px;" class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>></td>
                                       ...
                                       <td width="32%">
                                          ...
                                          ?>
                                          <select name="fam_id_from_p" id="fam_id_from_p" class="widthFix"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                           ...
                           <tr>
                              ...
                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="22%" align="left"><input name="fam_id_date_begin" type="text"  class="input_text" id="fam_id_date_begin" style="width: 80px;"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('fam_id_date_begin','YYYY-MM-DD')"  style="cursor:pointer"/><?php } ?></td>
                                       <td width="25%" align="right" class="form_text">วันบัตรหมดอายุ :&nbsp; </td>
                                       <td width="53%" align="left"><input name="fam_id_date_exp" type="text"  class="input_text" id="fam_id_date_exp" style="width: 80px;"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('fam_id_date_exp','YYYY-MM-DD')"  style="cursor:pointer"/><?php } ?></td>
                                    </tr>
                                 </table></td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="27%" align="left"><input type="text" name="fam_occupation" id="fam_occupation" style="width: 150px;"  class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="19%" align="right" class="form_text">สถานที่ทำงาน :&nbsp; </td>
                                       <td width="54%" align="left"><input type="text" name="fam_work_place" id="fam_work_place" style="width: 250px;"  class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                    </tr>
                                 </table></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">โทรศัพท์มือถือ :</td>
                              <td colspan="2" align="left"><input type="text" name="fam_mobile" id="fam_mobile" style="width: 110px;"  class="input_text" onkeyup="chkNum('fam_mobile','OnlyNm');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">โทรศัพท์ที่ทำงาน :</td>
                              <td colspan="2" align="left"><input type="text" name="fam_work_phone" id="fam_work_phone" style="width: 110px;"  class="input_text" onkeyup="chkNum('fam_work_phone','OnlyNm');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">โทรศัพท์บ้าน :</td>
                              <td colspan="2" align="left"><input name="fam_phone" type="text"  class="input_text" id="fam_phone" style="width: 110px;" onkeyup="chkNum('fam_phone','OnlyNm');" maxlength="7"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">โทรสาร :</td>
                              <td colspan="2" align="left"><input name="fam_fax" type="text"  class="input_text" id="fam_fax" style="width: 110px;" onkeyup="chkNum('fam_fax','OnlyNm');" maxlength="7"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">e-mail :</td>
                              <td colspan="2" align="left" class="form_text"><input type="text" name="fam_email" id="fam_email" style="width: 100px;"  class="input_text" onblur="chkEml('fam_email','ValidEml');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                              ...
                              <td width="130" align="left"><input type="text" name="fam_house_no" id="fam_house_no" style="width: 100px;" class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           ...
                           <tr>
                              ...
                              <td colspan="2" align="left"><input type="text" name="fam_moo" id="fam_moo" style="width: 80px;" class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ตึก/อาคาร :</td>
                              <td colspan="2" align="left"><input type="text" name="fam_building" id="fam_building" style="width: 120px;" class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">หมู่บ้าน :</td>
                              <td colspan="2" align="left"><input type="text" name="fam_village" id="fam_village" style="width: 120px;" class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ห้อง :</td>
                              <td colspan="2" align="left"><input type="text" name="fam_room" id="fam_room" style="width: 120px;" class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ซอย :</td>
                              <td colspan="2" align="left"><input type="text" name="fam_soi" id="fam_soi" style="width: 120px;" class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ถนน :</td>
                              <td colspan="2" align="left"><input type="text" name="fam_road" id="fam_road" style="width: 120px;" class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              ...
                              <td align="left" valign="middle">
                                 <span id='tumbon2'>
                                    <!--
                                    <select name="fam_tumbon" id="fam_tumbon" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                    <option value="" ></option>
                                      </select>-->
                                    <input type="hidden" name="fam_tumbon" id="fam_tumbon" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> <?php } ?>>
                                    <input type="text" class="input_text" readonly='readonly'  style="width: 120px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                 </span></td>
                              <td align="left" valign="middle"><?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/search_icon.gif" width="25" border="0"  align="middle" style="cursor:pointer" id="opener_address3" title="ค้นหา"/><?php } ?></td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2" align="left">
                                 <div id="amphur2">
                                    <!--
                                    <select name="fam_amphur" id="fam_amphur" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
	<option value="" ></option>
                                        </select>
                                    -->
                                    <input type="hidden" name="fam_amphur" id="fam_amphur" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> <?php } ?>>
                                    <input type="text" class="input_text" readonly='readonly' style="width: 120px" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2" align="left">
                                 <div id="province2">
                                    <!--
                                   <select name="fam_province" id="fam_province" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
	<option value="" ></option>
                                       </select>
                                    -->
                                    <input type="hidden" name="fam_province" id="fam_province" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> <? } ?>>
                                    <input type="text" readonly='readonly' class="input_text" style="width: 120px" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                           ...
                           <span id="nation5"><!--<select name="fam_country" id="fam_country" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                    ...
                                    <input type="hidden"  name="fam_country" id="fam_country"  style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> <? } ?>>
                                    <input type="text" class="input_text" readonly='readonly' style="width: 120px" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                 </span> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/search_icon.gif" width="25" border="0"  align="absmiddle" style="cursor:pointer" id="opener5"  title="ค้นหา"/><?php } ?>
                          ...
                          <!-- <tr>
                           ...
                           <tr>
                              <td align="right" >&nbsp;<input type='text' id='hid_fam_cen_file' name='hid_fam_cen_file' style="display:none"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?> /></td>
                              <td colspan="2" align="left">
                                 <?
                                 /*  if($row["fam_cen_file"] != ""){
