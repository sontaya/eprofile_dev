...
<table cellpadding="0" cellspacing="0" align="center" width="758">
   <tr><td >
         ...
         <div align="center"  id="toggle_form"><?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/add.png" onclick="toggle_form('children_data','')" style="cursor:pointer"/><?php } ?>&nbsp;</div>
                     ...
                     <form id="children_data" name="children_data" enctype="multipart/form-data" method="post" action="children_data_save.php"  target="upload_target">
                        <table width="100%" border="0" cellspacing="4" cellpadding="4">
                           <tr>
                              ...
                              <td colspan="2">
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="14%">
                                          <select name="chl_title_th" id="chl_title_th" onchange="swap_chl_title_th();"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                       ...
                                       <td width="15%" align="left"><input type="text" name="chl_fname_th" id="chl_fname_th" style="width: 80px; " class="input_text" onkeyup="chkTh('chl_fname_th','OnlyThai');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="14%" align="right" class="form_text">ชื่อกลาง : &nbsp;</td>
                                       <td width="16%" align="left"><input type="text" name="chl_mname_th" id="chl_mname_th" style="width: 80px; " class="input_text" onkeyup="chkTh('chl_mname_th','OnlyThai');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="14%" align="right" class="form_text">นามสกุล : &nbsp;</td>
                                       <td width="19%"><input type="text" name="chl_lname_th" id="chl_lname_th" style="width: 80px; " class="input_text" onkeyup="chkTh('chl_lname_th','OnlyThai');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                    </tr>
                                 </table></td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2">
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="12%">
                                          <select name="chl_title_en" id="chl_title_en" onchange="swap_chl_title_en();"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                             <option value="0">เลือก</option>
                                       ...
                                       <td width="15%" align="left"><input type="text" name="chl_fname_en" id="chl_fname_en" style="width: 80px; " class="input_text" onkeyup="chkEn('chl_fname_en','OnlyEn');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="13%" align="right" class="form_text">Mname : &nbsp;</td>
                                       <td width="15%" align="left"><input type="text" name="chl_mname_en" id="chl_mname_en" style="width: 80px; " class="input_text" onkeyup="chkEn('chl_mname_en','OnlyEn');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="13%" align="right" class="form_text">Lname : &nbsp;</td>
                                       <td width="21%"><input type="text" name="chl_lname_en" id="chl_lname_en" style="width: 80px; " class="input_text" onkeyup="chkEn('chl_lname_en','OnlyEn');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                    </tr>
                                 </table>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2" align="left"><input name="chl_sex" type="radio" id="chl_sex"  value="male"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>/>  ชาย <input type="radio" name="chl_sex" id="chl_sex" value="female"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> />  หญิง</td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="30%" align="left">
                                          ...
                                          ?>
                                <span id="nation9"><!--<select name="chl_nation1" id="chl_nation1" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                             <?= $option_chl_nation1 ?>
                                       </select>-->

                                             <input type="hidden" name="chl_nation1" id="chl_nation1" value="<?= $row_chl_nation1["NATION_ID"] ?>" />
                                             <input type="text" style="width:130px;" readonly='readonly' value="<?= $name_country ?>" <?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> />

                                          </span> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/search_icon.gif" width="25" border="0"  align="absmiddle" style="cursor:pointer" id="opener9"  title="ค้นหา"/><?php } ?>
                                       </td>
                                       ...
                                       <td width="33%" align="left">
                                          ...
                                          </span> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/search_icon.gif" width="25" border="0"  align="absmiddle" style="cursor:pointer" id="opener7"  title="ค้นหา"/><?php } ?>
                           ...
                           <tr>
                              ...
                              <td colspan="2" align="left">
                                 ...
                                 ?>
                                 <select name="chl_religion" id="chl_religion" class="widthFix"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                    <?= $option_chl_religion ?>
                                 </select>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2" align="left"><input  name="chl_birthday" onblur="Age('chl_birthday','chl_s_year','chl_s_month')" type="text" class="input_text" id="chl_birthday" style="width: 80px; "<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('chl_birthday','YYYY-MM-DD');$('#chl_birthday').focus()"  style="cursor:pointer"/><?php } ?> ex. 15/10/2553
                                 &nbsp; &nbsp;สถานะ : <input name="chl_alive" type="radio" id="chl_alive" value="1" checked="checked"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>/> มีชีวิต <input type="radio" id="chl_alive" name="chl_alive" value="2"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /> ถึงแก่กรรม  <input type="radio" id="chl_alive" name="chl_alive" value="3"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> /> สาบสูญ</td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ปัจจุบันอายุ :</td>
                              <td colspan="2" align="left"><input type="text"  style="width: 25px; border:none; " readonly="readonly" name="chl_s_year" id="chl_s_year" onfocus="Age('chl_birthday','chl_s_year','chl_s_month')"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> ปี <input type="text"  style="width: 25px; border:none; " readonly="readonly" name="chl_s_month" id="chl_s_month" onfocus="Age('chl_birthday','chl_s_year','chl_s_month')"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> เดือน</td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">สถานศึกษา :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_school" id="chl_school" style="width: 150px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/>
                                 &nbsp;อำเภอ : <input type="text" name="chl_sch_amphur" id="chl_sch_amphur" style="width: 100px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/> 
                                 &nbsp;จังหวัด : <input type="text" name="chl_sch_province" id="chl_sch_province" style="width: 100px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ระดับการศึกษา :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_sch_level" id="chl_sch_level" style="width: 150px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">* เลขประจำตัวประชาชน :</td>
                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="22%" align="left"><input type="text" name="chl_code_id" id="chl_code_id" style="width: 120px; " maxlength="13" class="input_text" onkeyup="chkNum('chl_code_id','OnlyNm');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="20%" align="right" class="form_text">ความสัมพันธ์ : &nbsp;</td>
                                       <td width="20%"><select name="chl_relation" id="chl_relation"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                             <option value="0">เลือก</option>
                           ...
                           <tr>
                              ...
                              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                       <td width="28%" align="left"><input type="text" name="chl_occupation" id="chl_occupation" style="width: 150px; "  class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                       <td width="21%" align="right" class="form_text">สถานที่ทำงาน :&nbsp; </td>
                                       <td width="51%" align="left"><input type="text" name="chl_work_place" id="chl_work_place" style="width: 250px; "  class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                                    </tr>
                                 </table></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">โทรศัพท์มือถือ :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_mobile" id="chl_mobile" style="width: 110px; "  class="input_text"  onkeyup="chkNum('chl_mobile','OnlyNm');" maxlength="30"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">โทรศัพท์ที่ทำงาน :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_work_phone" id="chl_work_phone" style="width: 110px; "  class="input_text" onkeyup="chkNum('chl_work_phone','OnlyNm');" maxlength="30"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">โทรศัพท์บ้าน :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_phone" id="chl_phone" style="width: 110px; "  class="input_text" onkeyup="chkNum('chl_phone','OnlyNm');" maxlength="30"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">โทรสาร :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_fax" id="chl_fax" style="width: 110px; "  class="input_text" onkeyup="chkNum('chl_fax','OnlyNm');" maxlength="30"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">e-mail :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_email" id="chl_email" style="width: 100px; "  class="input_text" onblur="chkEml('chl_email','ValidEml');"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                              ...
                              <td width="130" align="left"><input type="text" name="chl_house_no" id="chl_house_no" style="width: 100px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           ...
                           <tr>
                              ...
                              <td colspan="2" align="left"><input type="text" name="chl_moo" id="chl_moo" style="width: 80px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ตึก/อาคาร :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_building" id="chl_building" style="width: 120px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">หมู่บ้าน :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_village" id="chl_village" style="width: 120px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ห้อง :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_room" id="chl_room" style="width: 120px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ซอย :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_soi" id="chl_soi" style="width: 120px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                              <td align="right" class="form_text">ถนน :</td>
                              <td colspan="2" align="left"><input type="text" name="chl_road" id="chl_road" style="width: 120px; " class="input_text"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
                           </tr>
                           <tr>
                             ...
                             <!--<select name="chl_tumbon" id="chl_tumbon" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                    ...
                                    <input type="text" class="input_text" readonly='readonly' value="<?= $row_chl_tumbon["NAME_REF_TUMBON"] ?>" style="width: 120px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> />

                                 </span></td>
                              <td align="left" valign="middle"><?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/search_icon.gif" width="25" border="0"  align="middle" style="cursor:pointer" id="opener_address4"  title="ค้นหา"/><?php } ?></td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2" align="left">
                                 <div id='amphur2'>
                                    ...
                                    <input type="text" readonly='readonly' class="input_text" value="<?= $row_chl_amphur["NAME_REF_AMPHUR"] ?>" style="width: 120px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              ...
                              <td colspan="2" align="left">
                                 <div id='province2'>
                                    ...
                                    <input type="text" class="input_text" readonly='readonly' value="<?= $row_chl_province["NAME_REF_PROVINCE"] ?>" style="width: 120px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> />
                                 </div>
                              </td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                              ...
                              <td colspan="2" align="left">
                                 ...
                                 <span id="nation8">
                                    <!--
                                    <select name="chl_country" id="chl_country" style="width: 130px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                                    <?= $option_chl_nation1 ?> 
                                           </select>
                                    --> 
                                    <input type="hidden" name="chl_country" id="chl_country"  value="" />
                                    <input type="text" class="input_text" readonly='readonly' value="" style="width: 120px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?> />   

                                 </span> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/search_icon.gif" width="25" border="0"  align="absmiddle" style="cursor:pointer" id="opener8"  title="ค้นหา"/><?php } ?>
                              </td>
                           </tr>
                     <!--      <tr>
                           ...
                           <tr>
                              <td align="right" >&nbsp;<input type='text' id='hid_chl_cen_file' name='hid_chl_cen_file' style="display:none"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> disabled="disabled"<?php } ?>/></td>
