          ...
          <tr>
            <td width="746" valign="top">
              <form id="education" name="education" enctype="multipart/form-data" method="post" action="education_data_save.php" target="upload_target">
                <table width="748" border="0" cellpadding="4" cellspacing="4">
                  <tr >
                  ...
                  <tr>
                    ...
                    <td align="left">
                      ...
                      ?>
                      <select name="edu_level" id="edu_level" style="width:180px"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> onfocus="myDisable(this);"<?php } ?>>
                        <?= $option_edu_level ?>
                      </select>
                    </td>
                    <td align="left">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td align="left">
                    <select name="edu_country" id="edu_country" >
                  ...
                  <tr>
                    <td align="right" class="form_text">* วันที่สำเร็จการศึกษา :</td>
                    <td align="left"><!--<input type="text" name="edu_year" id="edu_year" style="width: 40px; "  maxlength="4" class="input_text"/>-->
                      <input type="text" name="edu_year" id="edu_year" style="width:100px;">
                      <img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('edu_year','YYYY-MM-DD')"  style="cursor:pointer"/>
                  ...
                  <tr>
                    <td align="right" class="form_text">วิชาเอก อื่น ๆ :</td>
                    <td colspan="2" align="left"> <input type="text" id="edu_program2" name="edu_program2"  class="input_text" style="width: 200px;"/></td>
                  </tr>
                  ...
                  <tr>
					...
					<tr>
                    <td align="right" class="form_text">กล่มสาขาวิชา อื่น ๆ :</td>
                    <td colspan="2" align="left"><input type="text" id="edu_major2" name="edu_major2"  class="input_text" style="width: 200px;"/></td>
                  </tr>
                  <tr>
                  ...
                  <tr id="row-audit" >
                    ...
                    <td colspan="2" align="left"><input name="audit_check" type="checkbox" id="id_audit_check" value="Y" onClick="if(document.getElementById('id_audit_check').checked==true){ document.getElementById('check_audit_date').style.display='block'; }else{ document.getElementById('check_audit_date').style.display='none'; }">
                    <label for="audit_check">สถานะการตรวจสอบวุฒิการศึกษา </label></td>
                  </tr>
                  <tr>
                  	<td>&nbsp;</td><td colspan="2"><div id="check_audit_date" style="display:none;"><table width="100%" border="0">
                    	<tr>
                        	<td><input type="radio" name="cert_confirm" id="cert_confirm" value="Y" />รับรอง</td>
                            <td><input type="radio" name="cert_confirm" id="cert_confirm" value="N" />ไม่รับรอง</td>
                        </tr>
                    	<tr>
                        	<td colspan="2">หนังสือออก <input type="text" name="cert_at" id="cert_at" style="width:100px;"/> เลขที่ออก <input name="cert_number_at" id="cert_number_at" type="text" style="width:100px;" /> วันที่ออก <input type="text" name="cert_date" id="cert_date" style="width:100px;"><img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('cert_date','YYYY-MM-DD')"  style="cursor:pointer"/></td>
                        </tr>
                    	<tr>
                        	<td colspan="2">หนังสือตอบรับ <input type="text" name="cert_answer_at" id="cert_answer_at" style="width:100px;"/> เลขที่ออก <input name="cert_answer_number_at" id="cert_answer_number_at" type="text" style="width:100px;" /> วันที่ออก <input type="text" name="cert_answer_date" id="cert_answer_date" style="width:100px;"><img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('cert_answer_date','YYYY-MM-DD')"  style="cursor:pointer"/></td>
                        </tr>
                    </table></div>&nbsp;</td>
                  </tr>
                  <tr>
...
$(document).ready(function() {    
    $('#id_audit_check').click(function() {
        if($(this).is(":checked"))
        {
           $("#row-audit").css("background-color","#090");
        } else {
            $("#row-audit").css("background-color","");
        }
    });
});
</script>
