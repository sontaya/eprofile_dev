   ...
   <table width="98%"  border="0" align="center"  bgcolor="#e9e9e9" >
      ...
      while (($row = oci_fetch_array($stid, OCI_BOTH))) {
         ...
         <tr align="center" height="20" valign="top">
            ...
            <td align="left" class="text_td text_data"><? if ($row["SCH_MAJOR"] == "oth")
         echo $row["SCH_MAJOR_OTH"]; else
         echo $isced[$row["SCH_MAJOR"]]["ISCED_NAME_TH"]; /*get_edu_major($row["SCH_MAJOR"], TB_REF_PROGRAM);*/ ?></td>
