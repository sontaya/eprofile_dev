...
function change_inner_form(id,page){
	if(id == ""){
		$("div#pos_ach_form"+page).html("");
		$("select#va_type"+page).val("");
	}else{
		load_sch_ach_form(id,page);
...
<table cellpadding="0" cellspacing="0" align="center" width="758">
	...
	<ul>
		<li><a href="#tabs-1" onclick="load_pos_list('1');load_ach_list('1');">ตำแหน่ง ผศ./ผศ.พิเศษ</a></li>
		<li><a href="#tabs-2" onclick="load_pos_list('2');load_ach_list('2');">ตำแหน่ง รศ./รศ.พิเศษ</a></li>
		<li><a href="#tabs-3" onclick="load_pos_list('3');load_ach_list('3'); ">ตำแหน่ง ศ./ศ.พิเศษ</a></li>
        <!--<li><a href="#tabs-4" onclick="load_pos_list('4');load_ach_list('4'); ">ตำแหน่ง ศ.11</a></li>-->
	</ul>
	<div id="tabs-1">
        <table  cellspacing="0" cellpadding="0" align="center" >
 <tr>
    <td width="670" >
    <form id="position1" name="position1" method="post" action="position_data_save.php"  target="upload_target" >
    <input type="hidden" id="vp_type" name="vp_type" value="1" />
    <div style="width:670px;">
   <fieldset>
     <legend style="font:17px bold;">ตำแหน่ง ผู้ช่วยศาสตราจารย์  / ผู้ช่วยศาสตราจารย์พิเศษ</legend><br />
 ...
 <tr>
    <td width="670" >
    <form id="position2" name="position2" method="post" action="position_data_save.php"  target="upload_target" >
    <input type="hidden" id="vp_type" name="vp_type" value="2" />
    <div style="width:670px;">
   <fieldset>
     <legend style="font:17px bold;">ตำแหน่ง รองศาสตราจารย์  / รองศาสตราจารย์พิเศษ</legend><br />
 ...
 <tr>
    <td width="670" >
    <form id="position3" name="position3" method="post" action="position_data_save.php"  target="upload_target" >
    <input type="hidden" id="vp_type" name="vp_type" value="3" />
    <div style="width:670px;">
   <fieldset>
     <legend style="font:17px bold;">ตำแหน่ง ศาสตราจารย์  / ศาสตราจารย์พิเศษ</legend><br />
 ...
 <tr>
    <td width="670" >
    <form id="position4" name="position4" method="post" action="position_data_save.php"  target="upload_target" >
    <input type="hidden" id="vp_type" name="vp_type" value="4" />
    <div style="width:670px;">
   <fieldset>
     <legend style="font:17px bold;">ตำแหน่ง ศาสตราจารย์ 11</legend><br />
     <div id="pos_list4"  align="center">
	 </div>
</fieldset>
</div>
</form>
  ...
  <tr>
    ...
    <div style="width:650px;">
   <fieldset><legend style="font:17px bold;">ผลงาน</legend><br />
   <div id="pos_ach_list4" align="center">
    </div>
    </fieldset>
    </div>
    </td>
