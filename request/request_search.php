...
function check_data(){
	...
	ajaxPostData("./../request/request_return_search.php",data,"text","search_res",result_search,"","");
}
...
function red_detail(emp_id){
	document.getElementById("request3").innerHTML="";
	$('#request3').dialog("open");
	
			$.post("./../request/request_data.php",{re_id:emp_id},
			function(data){
				document.getElementById("request3").innerHTML=data;
		});	
}
 
</script>
<div id="request1" titel="รายละเอียด"><div id="request2"></div></div>
<div id="request3" titel="รายละเอียด"></div>
