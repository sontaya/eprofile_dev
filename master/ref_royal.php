    ...
    $('#fAdd8').dialog({
      ...
      buttons: {
        'เพิ่ม': function() {
          ...
          $.ajax({
            type: 'POST',
            url : '../master/ref_royal_ajax.php',
            data : {mode : 'add',
              expert_name : expert_name  
            },
            success : function(data){
              $('#tableList').load('../master/ref_royal.php?'+Math.random()+' #tableList');
              alert(data)
            }
          });
          $(this).dialog('close');
...
<body>
  ...
  <div id="mainContainer" >
    <h3>Master ชั้นของเครื่องราชฯ</h3>
    ...
    <div id ="tableList">
      ...
      <table width="485" border="1" class="all_table">
        <tr>
          <th width="300" scope="col">เครื่องราชอิสริยาภรณ์</th>
        ...
        while ($rc = oci_fetch_array($st, OCI_ASSOC)) {
          ...
          ?>
          <tr>
            <td><span id="expert_name_id_<?php echo $rc['ROYAL_ID']; ?>"><?php echo $rc['ROYAL_NAME']; ?></span></td>
            <td align="center"><span onClick="open_f('<?php echo $rc['ROYAL_ID']; ?>')" style="cursor:pointer"><img src="images/b_edit.png" width="16" height="16" title="Edit" class="vtip" /></span></td>
            <td align="center"><span onClick="open_d('<?php echo $rc['ROYAL_ID']; ?>')" style="cursor:pointer"><img src="images/b_del.png" width="12" height="12" title="Delete" class="vtip" /></span></td>
          </tr>
          <?php
        }
        ?>
