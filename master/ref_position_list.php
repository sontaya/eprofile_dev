    ...
    $('#fAdd').dialog({
      ...
      buttons: {
        'เพิ่ม': function() {
          ...
          $.ajax({
            type: 'POST',
            url : '../master/ref_position_list_ajax.php',
            data : {mode : 'add',
              code : code,
              position : position,
            ...
            success : function(data){
              $('#tableList').load('../master/ref_position_list.php?'+Math.random()+' #tableList');
              alert(data)
            }
          });
          $(this).dialog( "destroy" );
  ...
  <div id="mainContainer" >
    ...
    <script src="../js/vtip.js" type="text/javascript"></script>
      ...
      <table width="485" class="all_table" border="1" >
        <tr>
          ...
          <th width="292" scope="col">Position (eng)</th>
          <th width="63" scope="col">แก้ไข</th>
          <th width="51" scope="col">ลบ</th>
        </tr>
        <?php
        // require connected
        $sql = "SELECT POSITION_ID, POSITION_NAME_TH , POSITION_NAME_ENG FROM sdu_ref_position ORDER BY POSITION_ID ";
        ...
        ?>
          <tr>
            <td><?php echo $rc['POSITION_ID']; ?></td>
            <td><span id="position_txt_<?php echo $rc['POSITION_ID']; ?>"><?php echo $rc['POSITION_NAME_TH']; ?></span></td>
            <td><span id="position_e_txt_<?php echo $rc['POSITION_ID']; ?>"><?php echo $rc['POSITION_NAME_ENG']; ?></span></td>
            <td align="center"><span onClick="open_f('<?php echo $rc['POSITION_ID']; ?>')" style="cursor:pointer"><img src="images/b_edit.png" width="16" height="16" class="vtip" title="Edit" /></span></td>
            <td align="center"><span onClick="open_d('<?php echo $rc['POSITION_ID']; ?>')" style="cursor:pointer"><img alt=""  src="images/b_del.png" width="12" height="12" class="vtip" title="Delete" /></span></td>
          </tr>
        <?php
        }
        ?>
    ...
    <div id="fEdit" style="display:none;" title="แก้ไข">
    	<table border="0" style="border:none;">
            ...
            <tr>
     		 	 <td align="right">Position :</td><td><input type="text" id="e_position" name="e_position" /></td>
            </tr>
            <tr>
     			  <td align="right">Position(ENG) :</td><td><input type="text" id="e_position_e" name="e_position_e" /></td>
            </tr>
      	</table>
    </div>
