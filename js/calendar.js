...
function showCalendar(id) {
	...
	if (calendar != null) {
		...
		cal.setRange(1900, 3500);	// min/max year allowed
...
Calendar.prototype._init = function (mondayFirst, date) {
	var today = new Date();
	var year = eval(date.getFullYear()+543);
	if(year > 3000) year = eval(year -543);
...
Date.prototype.print = function (frm) {
	...
	var m = this.getMonth();
	var d = this.getDate();
	var y = eval(this.getFullYear()+543);
	if(y > 3000) y = eval(y -543);
...
// tooltips
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "สลับ";
Calendar._TT["PREV_YEAR"] = "ปีที่แล้ว";
Calendar._TT["PREV_MONTH"] = "เดือนที่แล้ว";
Calendar._TT["GO_TODAY"] = "วันนี้";
Calendar._TT["NEXT_MONTH"] = "เดือนต่อไป";
Calendar._TT["NEXT_YEAR"] = "ปีต่อไป";
Calendar._TT["SEL_DATE"] = "เลือกวัน";
Calendar._TT["DRAG_TO_MOVE"] = "ลาก";
Calendar._TT["PART_TODAY"] = " (วันนี้)";
Calendar._TT["MON_FIRST"] = "MON_FIRST";
Calendar._TT["SUN_FIRST"] = "SUN_FIRST";
...
Calendar._TT["TT_DATE_FORMAT"] = "d MM y";
