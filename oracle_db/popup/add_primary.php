...
function add(){
	...
	$.post("./../ajax/ajax_add_primary_key.php", {table:$("#table").val() , constraint_name:$("#constraint_name").val() , column:$("#column").val()}, 
		function(data){
			if(data=="OK"){
				alert("สร้าง Primary Key เรียบร้อย");
...
<div class="title">สร้าง PRIMARY</div>
<div id="page_data">
<table>
	<tr>
    ...
    <tr>
        ...
        <td><input type="text" style="width:200px;" id="constraint_name" value="<?=$_GET["table"]?>_PK" /></td>
    </tr>
    <tr>
    	<td align="right"></td>
